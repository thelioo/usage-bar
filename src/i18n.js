...
const MESSAGES = {
  en: {
    ...
    modeTaskbar: "Taskbar", dragHint: "Tip: drag the island to the top, bottom or a side of any monitor, or onto the taskbar.",
    sPosition: "Position", anchor_top: "Top (island)", anchor_left: "Left edge", anchor_right: "Right edge", anchor_bottom: "Bottom",
  },
  pt: {
    ...
    modeTaskbar: "Barra de tarefas", dragHint: "Dica: arraste a ilha para o topo, a parte inferior ou uma lateral de qualquer monitor, ou para a barra de tarefas.",
    sPosition: "Posição", anchor_top: "Topo (ilha)", anchor_left: "Lateral esquerda", anchor_right: "Lateral direita", anchor_bottom: "Inferior",
  },
  es: {
    ...
    modeTaskbar: "Barra de tareas", dragHint: "Consejo: arrastra la isla arriba, abajo o a un lado de cualquier monitor, o a la barra de tareas.",
    sPosition: "Posición", anchor_top: "Arriba (isla)", anchor_left: "Borde izquierdo", anchor_right: "Borde derecho", anchor_bottom: "Abajo",
  },
  fr: {
    ...
    modeTaskbar: "Barre des tâches", dragHint: "Astuce : faites glisser l’île en haut, en bas ou sur un côté de n’importe quel écran, ou sur la barre des tâches.",
    sPosition: "Position", anchor_top: "En haut (île)", anchor_left: "Bord gauche", anchor_right: "Bord droit", anchor_bottom: "En bas",
  },
  de: {
    ...
    modeTaskbar: "Taskleiste", dragHint: "Tipp: Zieh die Insel an den oberen oder unteren Rand oder eine Seite eines beliebigen Bildschirms oder auf die Taskleiste.",
    sPosition: "Position", anchor_top: "Oben (Insel)", anchor_left: "Linker Rand", anchor_right: "Rechter Rand", anchor_bottom: "Unten",
  },
  it: {
    ...
    modeTaskbar: "Barra delle applicazioni", dragHint: "Suggerimento: trascina l’isola in alto, in basso o su un lato di qualsiasi monitor, oppure sulla barra delle applicazioni.",
    sPosition: "Posizione", anchor_top: "In alto (isola)", anchor_left: "Bordo sinistro", anchor_right: "Bordo destro", anchor_bottom: "In basso",
  },
  ja: {
    ...
    modeTaskbar: "タスクバー", dragHint: "ヒント: アイランドは任意のモニターの上端・下端・左右の端、またはタスクバーにドラッグできます。",
    sPosition: "位置", anchor_top: "上部（アイランド）", anchor_left: "左端", anchor_right: "右端", anchor_bottom: "下部",
  },
  zh: {
    ...
    modeTaskbar: "任务栏", dragHint: "提示：可以将灵动岛拖到任意显示器的顶部、底部或两侧，或拖到任务栏。",
    sPosition: "位置", anchor_top: "顶部（灵动岛）", anchor_left: "左侧", anchor_right: "右侧", anchor_bottom: "底部",
  },
  ko: {
    ...
    modeTaskbar: "작업 표시줄", dragHint: "팁: 아일랜드를 모니터의 위, 아래, 양옆 또는 작업 표시줄로 끌어 놓을 수 있습니다.",
    sPosition: "위치", anchor_top: "상단 (아일랜드)", anchor_left: "왼쪽 가장자리", anchor_right: "오른쪽 가장자리", anchor_bottom: "하단",
  },
  ru: {
    ...
    modeTaskbar: "Панель задач", dragHint: "Совет: перетащите остров к верхнему или нижнему краю, к боковой стороне любого монитора или на панель задач.",
    sPosition: "Положение", anchor_top: "Сверху (остров)", anchor_left: "Левый край", anchor_right: "Правый край", anchor_bottom: "Снизу",
  },
};
